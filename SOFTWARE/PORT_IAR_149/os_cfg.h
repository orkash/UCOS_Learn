...
*
*                           (c) Copyright 1992-2008, Jean J. Labrosse, Weston, FL
*                                           All Rights Reserved
*
...
#define OS_TICKS_PER_SEC       3125    /* Set the number of ticks in one second                        */


                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE    192    /* Timer      task stack size (# of OS_STK wide entries)        */
#define OS_TASK_STAT_STK_SIZE   192    /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE   192    /* Idle       task stack size (# of OS_STK wide entries)        */
